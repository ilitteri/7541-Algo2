...
\lstinputlisting[language=Python]{algorithms/sorting/counting_sort.py}
...
\lstinputlisting[language=Python]{algorithms/sorting/radix_sort.py}
...
\lstinputlisting[language=Python]{algorithms/sorting/bucket_sort.py}