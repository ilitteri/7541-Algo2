...
\begin{enumerate}
    \item  Implementar una función que dados dos arreglos de n y m elementos, respectivamente, devuelva si ambos arreglos tienen todos sus elementos diferentes entre sí en $O(n + m)$. Justificar el orden de la función implementada.
