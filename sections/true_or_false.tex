...
\begin{enumerate}
    ...
    \item
        \begin{enumerate}[label=\alph*]
            ...
            \item Si el grafo es no pesado, de todas formas los Algoritmos de Prim y Jruskal se pueden utilizar y son la mejor opción para obtener un árbol de tendido.
        \end{enumerate}
    \item 
        \begin{enumerate}[label=\alph*]
    ...
    \item 
        \begin{enumerate}[label=\alph*]
            \item En un grafo bipartito no pueden haber ciclos con cantidad impar de vértices que lo compongan.
                ...
                \item En un grafo dirigido, no existe camino de un vpertice $v$ de una componente fuertemente conexa hacia un vértice $w$ de otra componente fuertemente conexa.
            \end{enumerate}
\end{enumerate}