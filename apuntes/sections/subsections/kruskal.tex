...
\begin{itemize}
    ...
    \item Funciona en $\Theta(1)$ (aprox.).
\end{itemize}
...
\begin{itemize}
    \item Crear el conjunto a partir de los vértices del grafo es $\Theta(V)$.
    \item Ordenar como mucho es $\Theta(E\log(V))$.
    \item El for es mínimo $\Theta(E)$, en el peor de los casos es $\Theta(E\log(V))$.
